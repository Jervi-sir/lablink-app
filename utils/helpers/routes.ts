export const Routes = {
  ...
  StudentSearchScreen: 'student-search-screen',
  ...
  LabEstimationScreen: 'lab-estimation-screen',
  CheckoutScreen: 'checkout-screen',
  OrderDetailScreen: 'order-detail-screen',
  EstimationDetailScreen: 'estimation-detail-screen',
  ...
  EstimationReviewScreen: 'estimation-review-screen',
  InventoryAnalyticsScreen: 'inventory-analytics-screen',
  LabOrdersScreen: 'lab-orders-screen',
