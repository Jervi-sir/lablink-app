...
import { Package, Calendar, Send, CheckCircle, ChevronLeft, FileText } from 'lucide-react-native';
      ...
      >
        ...
        {order.contract_pdf_url && (
          <Pressable
            ...
            className="mb-6 flex-row items-center justify-between rounded-2xl bg-white p-5 border border-slate-100 shadow-sm"
          >
            <View className="flex-row items-center gap-4">
