...
import { User as UserIcon, LogOut, Mail, Phone, GraduationCap, Save, Edit2, Shield, School, BookOpen, Copy, Bell, CheckCircle2 } from 'lucide-react-native';
...
export const StudentProfileScreen = () => {
  ...
  const handleSave = async () => {
    setLoading(true);
    try {
      const response: any = await api.post('/profile', {
        ...formData,
        // Ensure specialty is sent if backend supports it
      });
          ...
          <View className="gap-5">
            ...
            <View>
              ...
              <TextInput
                ...
                placeholder="مثال: بيولوجيا جزيئية"
                textAlign="right"
              />
            </View>
