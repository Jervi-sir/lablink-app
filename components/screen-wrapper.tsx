...
import {
  View, ViewStyle, Keyboard, TouchableWithoutFeedback, StatusBar, ImageBackground,
  ImageSourcePropType, Animated, Easing, Dimensions, Platform,
  StyleSheet,
} from 'react-native';
...
export const ScreenWrapper: React.FC<Props> = ({
  ...
  const Body = (
    <View
      style={[
        { flex: 1, backgroundColor: bodyBaseBg, paddingTop: disableTopInset ? 10 : (Platform.OS === 'ios' ? insets.top : insets.top + 4) },
        style,
        // {paddingTop: 0 }
      ]}
    >
  ...
  return (
    <View style={{ flex: 1, paddingTop: 30, backgroundColor: backgroundFallbackColor }}>
